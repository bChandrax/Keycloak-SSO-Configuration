...
import { loginWithGoogle } from './keycloak.service'
    ...
    <>
      ...
      <div className="login-root">
        ...
        <div className="login-card">
          ...
          <button className="btn-sso" onClick={loginWithGoogle} style={{ marginBottom: 10 }}>
          ...
          {/* SSO — also offers One-Time Password (OTP) login for accounts with OTP set up */}
          <button className="btn-sso" onClick={login}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/>
            </svg>
            Continue with SSO / OTP
          </button>
